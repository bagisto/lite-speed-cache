...
- **Bagisto 2.4 compatibility** — the package now targets [Bagisto v2.4.6](https://github.com/bagisto/bagisto/tree/v2.4.6).

### Changed

- Updated the minimum supported Bagisto version from **v2.3.6** to **v2.4.6** in the README and setup instructions.
...
- [Bagisto v2.4.4](https://github.com/bagisto/bagisto/tree/v2.4.4)
